...
exports.updatePassword = exports.updateCredentials = void 0;
...
var updateCredentials = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
    var name, email, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: 'http://127.0.0.1:3000/api/v1/users/updateUser',
              data: {
                name: name,
                email: email
              }
  ...
  return function updateCredentials(_x) {
    return _ref2.apply(this, arguments);
  };
}();
...
var profileFormElement = document.querySelector('#profile-form'); // DELEGATION
...
if (profileFormElement) {
  profileFormElement.addEventListener('submit', function (e) {
    ...
    (0, _accountSettings.updateCredentials)({
      name: name,
      email: email
    });
  });
