...
var updateAccountCredentials = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
    var data, _ref$isPassword, isPassword, res;

    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            data = _ref.data, _ref$isPassword = _ref.isPassword, isPassword = _ref$isPassword === void 0 ? false : _ref$isPassword;
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/users/update".concat(isPassword ? 'Password' : 'User'),
              data: data
            });
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Changes saved successfully!');
            }
  ...
  return function updateAccountCredentials(_x) {
    return _ref2.apply(this, arguments);
  };
}();

var _default = updateAccountCredentials;
...
exports.deleteAccount = exports.logout = exports.login = void 0;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Account Succesfully deleted!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error deleting account!');
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(signinData) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'New Account Created!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
...
var createReview = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
    var tour, tourSlug, review, rating, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            tour = _ref.tour, tourSlug = _ref.tourSlug, review = _ref.review, rating = _ref.rating;
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'POST',
          ...
          case 4:
            ...
            if (res.data.status) {
              (0, _alert.showAlert)('success', 'Review successfully added!');
              window.setTimeout(function () {
...
var passwordFormElement = document.querySelector('#password-form');
var bookTourBtn = document.getElementById('book-tour-btn');
var reviewFormElement = document.getElementById('review-form');
var deleteAccountButton = document.getElementById('delete-account'); // DELEGATION

if (mapBoxElement) {
  var locations = JSON.parse(mapBoxElement.dataset.locations);
...
if (passwordFormElement) {
  passwordFormElement.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var saveBtn, currentPasswordEl, passwordEl, passwordConfirmEl, currentPassword, password, passwordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              currentPasswordEl = document.querySelector('#password-current');
              passwordEl = document.querySelector('#password');
              passwordConfirmEl = document.querySelector('#password-confirm');
              currentPassword = currentPasswordEl.value;
              password = passwordEl.value;
              passwordConfirm = passwordConfirmEl.value;
              saveBtn.textContent = 'Updating...';
              _context.next = 11;
              return (0, _accountSettings.default)({
                data: {
...
if (reviewFormElement) {
  reviewFormElement.addEventListener('submit', function (e) {
    ...
    var tourSlug = document.getElementById('tour-slug').value;
