...
var passwordFormElement = document.querySelector('#password-form'); // DELEGATION
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "37301" + '/');
